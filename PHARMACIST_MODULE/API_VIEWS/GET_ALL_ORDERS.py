...
class ALLORDERS_PHARMACY_VIEW(APIView):
    ...
    def PLACE_ORDER(self, USER_OBJECT):
        RESULTANT = []
        ALLORDERS = ORDERS_PLACED_MODEL.objects.filter(ORDERSPLACED_BID_PROFILE__PHARMICISTBIDDING_PHARMACIST_PROFILE=USER_OBJECT)
        for singleorder in ALLORDERS:
            RESULTANT.append({
                ...
                "ORDER_STATUS": singleorder.ORDERSPLACED_DELIVERED,
                "PHARMACY_PROFILE": {
