...
from DATABASE_LAYER.models import JWT_TOKEN_MODEL, CUSTOMER_USER_MODEL, ORDERS_PLACED_MODEL


class ORDERS_ALL_VIEW(APIView):
    ...
    def PLACE_ORDER(self, USER_OBJECT):
        ...
        ALLORDERS = ORDERS_PLACED_MODEL.objects.filter(
            ORDERSPLACED_CONTRACT_PROFILE__CUSTOMERPHARMACIST_CUSTOMER_PROFILE=USER_OBJECT)
